   ...
   <form id="form">
	   <dd>
	     ...
	     <input name="id" type="hidden" class="text" value="${page.id}"/>
	       ...
	       <li><label>留言人：</label><input type="text" class="text" name="messagePerson" value="${page.commentaryPerson}"/>
	       ...
	       <li><label><span>*</span>手机：</label><input type="text" class="text" name="cellphone" value="${page.cellphone}"/>
	        ...
	        <button type="button" onclick="formSubmitModel('commentaryFrontController.do?save', 'form');" class="btn blue">保存</button>
	     </ul>
	   </dd>
   </form>
 </dl>
