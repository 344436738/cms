...
<script type="text/javascript" src="${base}/res/js/jquery-1.4.4.min.js"></script>
<script type="text/javascript" src="${contextpath}/plug-in/My97DatePicker/WdatePicker.js"></script>
<script>
...
<div id="maincontent">
	...
	<div id="rightcontent">
		<#include "inc/testcommentary.ftl">
	</div>
	<div class="clear"></div>
</div>
