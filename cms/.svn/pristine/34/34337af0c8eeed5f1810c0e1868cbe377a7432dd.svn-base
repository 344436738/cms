...
public class ContentsEntity extends IdEntity implements java.io.Serializable {
	 ...
	 * @return
	 */
	@Column(name = "wechat_h5Url", nullable = false, length = 255)
	public String getWechatH5Url() {
		return wechatH5Url;
	}

	public void setWechatH5Url(String wechatH5Url) {
		this.wechatH5Url = wechatH5Url;
	}

	@Column(name = "open_flag", nullable = true, precision = 19, scale = 0)
	...
	@Column(name = "depart_ids", nullable = false, length = 1000)
	...
	@Column(name = "member_ids", nullable = false, length = 1000)
	...
	@Column(name = "supportcount", nullable = true, precision = 32, scale = 0)
	...
	@Column(name = "opposecount", nullable = true, precision = 32, scale = 0)
