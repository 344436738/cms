package com.leimingtech.common.hibernate.qbc;
	...
	public static void selectColumn(DetachedCriteria criteria, String[] columnNames,
		...
		for (String property : columnNames) {
			if(property.contains("_")){
				...
				tempProjectionList.add(Projections.property(StringUtils.getProperty(property)).as(StringUtils.getProperty(property)));
				hasJoniTable = true;
			}else{
