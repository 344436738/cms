 ...
 * 
 */
package com.leimingtech.member.servlet;
...
//			graphics.setFont(new Font("Arial Black", Font.ITALIC, 18));
		...
		// 将认证码存入SESSION
		UserUtils.getSession().setAttribute(SESSION_KEY_OF_RAND_CODE, resultCode);
	...
	private String exctractRandCode() {
		final String randCodeType = com.leimingtech.common.utils.ResourceUtil.getRandCodeType();
		int randCodeLength = Integer.parseInt(com.leimingtech.common.utils.ResourceUtil.getRandCodeLength());
