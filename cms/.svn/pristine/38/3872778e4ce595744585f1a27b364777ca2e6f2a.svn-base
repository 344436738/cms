	...
	<dl>
		...
		<dd>
			<form id="form">
				...
				<div style=" float: right; position: absolute; top:75px; right:0px;">
...
var aa = WebUploader.create({
    ...
    auto: true,
    // swf文件路径
    swf: '${domain}/${base}/res/ueditor/third-party/webuploader/Uploader.swf',
    // 文件接收服务端。
    server: '${domain}/${base}/controller.jsp?action=uploadimage',
    // 选择文件的按钮。可选。
