...
import com.leimingtech.base.entity.temp.SectionEntity;
...
import com.leimingtech.base.entity.temp.SectionDataEntity;
...
public class SectionController extends BaseController {
	...
	public String save(HttpServletRequest request, SectionEntity section) {
		...
		if (StringUtils.isNotEmpty(section.getId())) {
			...
			try {
				...
				t.setModifiedby(UserUtils.getUser().getId());
			...
			section.setSiteid(UserUtils.getSiteId());
	...
	public String createSectionStatic(HttpServletRequest request) {
		...
		try {
			staticMng.staticOneSectionClass(id,UserUtils.getSite());
	...
	public String sendSection(SectionDataEntity sectionData, HttpServletRequest request) {
			...
			for (int i=0;i<sectionids.length;i++){
				...
				section.setCreatedby(UserUtils.getUser().getId());
