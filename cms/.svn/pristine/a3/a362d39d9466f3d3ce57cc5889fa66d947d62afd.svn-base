package com.leimingtech.cms.service.statictemplate;
...
public interface IStatic {
	 ...
	 * 解析模板到页面
	 */
	void getFileHtml(SiteEntity site, String templateFilepath, Map<String, Object> data, HttpServletResponse response);
}
