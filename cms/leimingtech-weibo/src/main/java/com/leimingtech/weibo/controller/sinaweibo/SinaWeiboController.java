...
public class SinaWeiboController extends BaseController {
	...
	public String save(SinaWeiboEntity sinaWeibo, HttpServletRequest request) {
		...
		if (com.leimingtech.common.utils.StringUtils.isNotEmpty(sinaWeibo.getId())) {
			message = "新浪微博配置更新成功!";
			SinaWeiboEntity t = sinaWeiboService.getEntity(sinaWeibo.getId());
			try {
				com.leimingtech.common.utils.MyBeanUtils.copyBeanNotNull2Bean(sinaWeibo, t);
				...
				com.leimingtech.common.utils.LogUtil.info(message);
			} catch (Exception e) {
				e.printStackTrace();
				message = "新浪微博配置更新失败";
			...
			String site= UserUtils.getSiteId();
