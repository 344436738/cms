...
public interface ContentCatServiceI {
	 ...
	 * @return
     */
	JSONArray getzTreeData(String siteId);
	 ...
	 * 获取一级栏目
	 */
	List<ContentCatVOTreeEntity> getFirstCatList(String siteId);


	Integer checkUniqueCodeIsExist(String catId,String catUniqueCode,String siteid);
}
