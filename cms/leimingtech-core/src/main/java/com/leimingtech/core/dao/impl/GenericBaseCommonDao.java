...
import com.leimingtech.common.exception.BusinessException;
import com.leimingtech.common.hibernate.qbc.*;
import com.leimingtech.common.utils.LogUtil;
import com.leimingtech.common.utils.MyBeanUtils;
import com.leimingtech.common.utils.oConvertUtils;
...
public abstract class GenericBaseCommonDao<T, PK extends Serializable>
	...
	public int updateBySql(final String sql, Object... objects) {
		Query querys = this.createSQLQuery(getSession(),sql,objects);
		return querys.executeUpdate();
	}
	 ...
	 * @return
	 */
	public int updateByHql(final String hql, Object... objects) {
		Query querys = this.createQuery(getSession(), hql, objects);
		return querys.executeUpdate();
	}
	...
	public List<T> findListbySql(final String sql) {
		Query querys = this.createSQLQuery(getSession(), sql);
		return querys.list();
	}
	...
	public <T> List<T> query(String sql, RowMapper<T> clazz, Object... param) {
		return this.jdbcTemplate.query(sql,clazz,param);
	}
}
