...
public class BinaryUploader {
	...
	public static final State save(HttpServletRequest request,
			Map<String, Object> conf,String isMember) {
		...
		try {
			...
			savePath = PathFormat.parse(savePath, originFileName,isMember);
			mp4path = PathFormat.parse(mp4path, originFileName,isMember);
