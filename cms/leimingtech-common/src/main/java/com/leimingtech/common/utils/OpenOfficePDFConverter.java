...
//	    	htmlFilename=htmlFilename+".htm";
	...
	//打开一个word，不显示窗口
	try {
		com.jacob.com.Dispatch.put(xl, "Visible", new com.jacob.com.Variant(false));
		Object workbooks = xl.getProperty("Documents").toDispatch();
		Object workbook = com.jacob.com.Dispatch.call((com.jacob.com.Dispatch) workbooks, "Open",
				filename).toDispatch();
		com.jacob.com.Dispatch.invoke((com.jacob.com.Dispatch) workbook, "SaveAs", com.jacob.com.Dispatch.Method,
				new Object[] { htmlFilename, new com.jacob.com.Variant(8) }, new int[1]);
		com.jacob.com.Variant f = new com.jacob.com.Variant(false);
		//Close关闭文件，不关闭窗口
		com.jacob.com.Dispatch.call((com.jacob.com.Dispatch) workbooks, "Close", f);
	} catch (Exception e) {
		e.printStackTrace();
	} finally {
		// 调用office关闭方法，关闭窗口和word进程
		xl.invoke("Quit", new com.jacob.com.Variant[] {});
		xl = null;
	}
}
//
